...
def show_predict_page(model, output_path):
    ...
    return: 0: The patient is not likely to come back for the return visit 
            1: The patient is likely to come back fro the return visit
    """
    st.title("Prediction of patient's revisit within the next three months after diagnosis of colorectal cancer")
    ...
    chances_of_recur = st.selectbox("Reoccurance of colorectal cancer, 1 is reoccurance, 0 is no reoccurance", chances)
